    ...
    <div class="row justify-content-center">
        <div class="col-md-6">
            <div class="card employer-login">
                <div class="card-header d-flex justify-content-center custom-card-header">{{ __('Login As a Candidate') }}</div>
                <div class="card-body">
                    ...
                    <div class="card-footer text-center">
                        <p>Don't have an account? <a href="{{ route('candidate.register') }}">Sign up</a></p>
                    </div>
                </div>
            </div>
        </div>
