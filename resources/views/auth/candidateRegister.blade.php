    ...
    <div class="row justify-content-center">
        <div class="col-md-6">
            <div class="card employer-login">
                <div class="card-header d-flex justify-content-center custom-card-header">{{ __('Register as a Candidate') }}</div>
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('candidate.register') }}">
                        ...
                        <div class="form-group">
                            <p class="mb-0">Already have an account? <a href="{{ route('candidate.login') }}">Login</a></p>
                        </div>
